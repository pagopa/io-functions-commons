...
export const ContextMiddleware =
  (): IRequestMiddleware<"IResponseErrorInternal", Context> =>
  (request): Promise<E.Either<IResponse<"IResponseErrorInternal">, Context>> =>
    new Promise((resolve) => {
      pipe(
        ...
        O.fold(
          ...
          (context) =>
            resolve(E.right<IResponseErrorInternal, Context>(context)),
        ),
      );
    });
