...
export type DocumentComposedSearchKey<
  ...
  ReferenceIdKey extends keyof (BaseModel & T),
  // PartitionKey and ReferenceIdKey must refers two different fields.
  PartitionKey extends keyof Omit<BaseModel & T, ReferenceIdKey>,
> = readonly [(BaseModel & T)[ReferenceIdKey], (BaseModel & T)[PartitionKey]];
