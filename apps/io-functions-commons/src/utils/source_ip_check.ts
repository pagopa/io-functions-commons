...
export function checkSourceIpForHandler<P1, P2, P3, O>(
  ...
  p2: P2,
  p3: P3,
) => Promise<IResponseErrorForbiddenNotAuthorized | O>;
...
export function checkSourceIpForHandler<P1, P2, P3, P4, P5, P6, P7, O>(
  ...
  IResponseErrorForbiddenNotAuthorized | IResponseErrorInternal | O
> {
